...
namespace CesiumForUnity
{
    public partial class Cesium3DTileset : System.IDisposable
    {
        ...
        public partial void UpdateTilesetOptions()
        {
            ...
            {
                if (this._implementation == null || this._implementation.IsInvalid)
                    throw new NotImplementedException("The native implementation is missing so UpdateTilesetOptions cannot be invoked. This may be caused by a missing call to CreateImplementation in one of your constructors, or it may be that the entire native implementation shared library is missing or out of date.");
                DotNet_CesiumForUnity_Cesium3DTileset_UpdateTilesetOptions(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation);
            }
        }
        ...
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_Cesium3DTileset_UpdateTilesetOptions(System.IntPtr thiz, CesiumForUnity.Cesium3DTileset.ImplementationHandle implementation);
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
